# -*- coding: utf-8 -*-
"""
Created on Sun Nov 25 16:29:43 2018
...
def check_availability(meetings_list, dt_time):
    final_result = True
    for val in meetings_list:
        print(dt_time)
        print(val.start_time)
        print(val.end_time)
        if dt_time <= val.start_time or dt_time >= val.end_time:
...
'''meetings = [Meeting(datetime(2018, 8, 1, 14, 45, 0), datetime(2018, 8, 1, 16, 45, 0)), 
            Meeting(datetime(2018, 8, 6, 11, 0, 0), datetime(2018, 8, 6, 13, 0, 0)), 
            Meeting(datetime(2018, 8, 6, 9, 30, 0), datetime(2018, 8, 6, 12, 30, 0)), 
            Meeting(datetime(2018, 8, 7, 12, 45, 0), datetime(2018, 8, 7, 14, 15, 0))]
print(check_availability(meetings, datetime(2018, 8, 6, 10, 30, 0)))
